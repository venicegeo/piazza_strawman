...
wget http://apache.claz.org/kafka/0.8.2.1/kafka_2.10-0.8.2.1.tgz -c -P ansible/roles/kafka/files/
wget http://mirrors.sonic.net/apache/storm/apache-storm-0.9.5/apache-storm-0.9.5.tar.gz -c -P ansible/roles/storm/files/
